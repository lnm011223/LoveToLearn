...
class ChallengeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.errorBookButton.setOnClickListener {
            ...
            Navigation.findNavController(it).navigate(R.id.action_challengeFragment_to_challengeErrorBookFragment,null,null,extras)
        }
        binding.onlyExerciseButton.setOnClickListener {
            ...
            Navigation.findNavController(it).navigate(R.id.action_challengeFragment_to_challengeExerciseFragment,null,null,extras)
        }
